...
function GetAlarmPageListsuccFn (data){
	...
	if(data.rows!=null && data.rows.length!=0){
		...
		for(var i=0 ; data.rows.length>i;i++){
			...
			datalis+="<div class='mui-card'><div class='mui-card-content'><div><div class='score'><p class='branch'>50</p><p class='scoreType'>综合评分</p><div class='triangle'></div></div></div><div class='warningContent'><p class='warningCompany'>武汉普天科技有限公司</p><p class='warningType'>1分钟前</p></div></div></div>";
		}
...
mui('.mui-table-view-chevron').on('tap','.mui-card',function(){
	//window.location.href="details/lowWarningDetails.html?id="+$(this).attr('id');
})
